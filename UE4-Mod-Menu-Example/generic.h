...
struct TUObjectArray {
	...
	class UE_UObject FindObjectPartial(const std::string& name, const std::string& name2) const;
	class UE_UObject FindObjectByTypeAndContainsString(const std::string& type, const std::string& persistent, const std::string& objectname) const;
